...
<div class="main-wrapper" id="main-wrapper">
	...
	<div class="main-blocks" id="main-blocks">
		...
		<div class="main-box commodity-trading box-right" data-segment="media-entertainment">
			...
			<div class="scroll-img">
				<img src="assets/images/trading.jpg" alt="">
			</div>
		</div>
	...
	<div id="site-content" class="site-content">
		...
		<div class="segment" id="media-entertainment">
			<div class="module-image-text">
				...
				<div class="image-wrapper" style="background-image:url(assets/images/media.jpg);">
				</div>
				<div class="intro-title">
					<h1>Media & Enter<br>tainment</h1>
				</div>
				<div class="text-wrapper" style="background-color: #daeffb">
					<div>
		...
		<div class="segment" id="investment-banking">
			<div class="module-image-text">
				...
				<div class="image-wrapper" style="background-image:url(assets/images/investment.jpg);">
				</div>
				<div class="intro-title">
					<h1 style="color: rgba(0, 0, 0,0.5);">Investment Banking</h1>
				</div>
		...
		<div class="segment" id="about-us">
			<div class="module-image-text">
				...
				<div class="image-wrapper" style="background-image:url(assets/images/team.jpg);">
				</div>
				<div class="intro-title">
					<h1 style="color: rgba(255, 126, 189, 0.6);">Story Of <br>
					Morris Street</h1>
				</div>
		...
		<div class="segment" id="commodity-trading">
			<div class="module-image-text">
				...
				<div class="image-wrapper" style="background-image:url(assets/images/trading.jpg);">
				</div>
				<div class="intro-title">
